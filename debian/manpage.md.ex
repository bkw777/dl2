...
dl2 - program to do something

# SYNOPSIS

**dl2** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**dl2** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **dl2** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**dl2** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    dl2. See **foo.conf**(5) for further details.
...
**dl2** provides some return codes, that can be used in scripts:
...
Joshua O'Keefe <majick@nachomountain.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Joshua O'Keefe

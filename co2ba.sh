...
typeset -i i b e SUM TOP END EXE LEN n p g
typeset -a d=()
...
printf '%uCLEAR0:READT:CLEAR2,T:DEFINTI,O,C,V,L,W:DEFSNGA,K,S,T,X,E:DEFSTRB,M,D,N:READT,L,X,K,N,O,M:E=T+L-1:A=T:S=0:C=0:B=" ":W=0:CLS:PRINT"Installing "N\r' $n

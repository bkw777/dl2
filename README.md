...
The project is named "dl2" but the installed binary is just `dl` .  
Also included is [co2ba](co2ba.md), which generates loaders for use with the bootstrap function (`dl -b filename`).
